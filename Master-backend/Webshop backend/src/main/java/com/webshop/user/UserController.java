...
import com.webshop.config.security.JwtTokenUtil;
import com.webshop.config.security.JwtUserDetailsService;
import com.webshop.exception.InternalServerError;
import com.webshop.mail.MailService;
import com.webshop.user.dto.LoginForm;
import com.webshop.user.dto.RegistrationForm;
...
@RestController
@AllArgsConstructor
@CrossOrigin(value = "https://localhost:8089", exposedHeaders = "JWT")
